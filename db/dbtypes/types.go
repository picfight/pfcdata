...
import (
	...
	"github.com/picfight/pfcdata/v4/db/dbtypes/internal"
...
const (
	...
	// be effected. https://docs.picfight.org/glossary/#rule-change-interval-rci.
...
// Tx models a PicFight transaction. It is stored in a Block.
type Tx struct {
	//blockDbID  int64
...
type AddressInfo struct {
	...
	// https://github.com/picfight/pfcdata/v4/issues/358 for details.
	IsDummyAddress bool
