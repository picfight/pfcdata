...
const (
	AppName  string = "pfcdata"
	AppMajor uint   = 4
	AppMinor uint   = 1
	AppPatch uint   = 1
)

// go build -v -o pfcdata -ldflags "-X github.com/picfight/pfcdata/v4/version.appPreRelease= -X github.com/picfight/pfcdata/v4/version.appBuild=`git rev-parse --short HEAD`"
var (
