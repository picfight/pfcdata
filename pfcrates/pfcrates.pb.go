...
func (*ExchangeSubscription) Descriptor() ([]byte, []int) {
	return fileDescriptor_pfcrates_dcd22285f4ba2133, []int{0}
}
...
func (*ExchangeRateUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_pfcrates_dcd22285f4ba2133, []int{1}
}
...
func init() {
	proto.RegisterType((*ExchangeSubscription)(nil), "pfcrates.ExchangeSubscription")
	proto.RegisterType((*ExchangeRateUpdate)(nil), "pfcrates.ExchangeRateUpdate")
	proto.RegisterMapType((map[string]float64)(nil), "pfcrates.ExchangeRateUpdate.IndicesEntry")
}
...
// PFCRatesClient is the client API for PFCRates service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type PFCRatesClient interface {
	SubscribeExchanges(ctx context.Context, in *ExchangeSubscription, opts ...grpc.CallOption) (PFCRates_SubscribeExchangesClient, error)
}

type pFCRatesClient struct {
	cc *grpc.ClientConn
}

func NewPFCRatesClient(cc *grpc.ClientConn) PFCRatesClient {
	return &pFCRatesClient{cc}
}

func (c *pFCRatesClient) SubscribeExchanges(ctx context.Context, in *ExchangeSubscription, opts ...grpc.CallOption) (PFCRates_SubscribeExchangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PFCRates_serviceDesc.Streams[0], "/pfcrates.PFCRates/SubscribeExchanges", opts...)
	if err != nil {
		return nil, err
	}
	x := &pFCRatesSubscribeExchangesClient{stream}
...
type PFCRates_SubscribeExchangesClient interface {
	Recv() (*ExchangeRateUpdate, error)
	grpc.ClientStream
}

type pFCRatesSubscribeExchangesClient struct {
	grpc.ClientStream
}

func (x *pFCRatesSubscribeExchangesClient) Recv() (*ExchangeRateUpdate, error) {
...
// PFCRatesServer is the server API for PFCRates service.
type PFCRatesServer interface {
	SubscribeExchanges(*ExchangeSubscription, PFCRates_SubscribeExchangesServer) error
}

func RegisterPFCRatesServer(s *grpc.Server, srv PFCRatesServer) {
	s.RegisterService(&_PFCRates_serviceDesc, srv)
}

func _PFCRates_SubscribeExchanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExchangeSubscription)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(PFCRatesServer).SubscribeExchanges(m, &pFCRatesSubscribeExchangesServer{stream})
}

type PFCRates_SubscribeExchangesServer interface {
	Send(*ExchangeRateUpdate) error
	grpc.ServerStream
}

type pFCRatesSubscribeExchangesServer struct {
	grpc.ServerStream
}

func (x *pFCRatesSubscribeExchangesServer) Send(m *ExchangeRateUpdate) error {
	return x.ServerStream.SendMsg(m)
}

var _PFCRates_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pfcrates.PFCRates",
	HandlerType: (*PFCRatesServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SubscribeExchanges",
			Handler:       _PFCRates_SubscribeExchanges_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "pfcrates.proto",
}

func init() { proto.RegisterFile("pfcrates.proto", fileDescriptor_pfcrates_dcd22285f4ba2133) }

var fileDescriptor_pfcrates_dcd22285f4ba2133 = []byte{
