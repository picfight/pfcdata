  ...
  plotGraph (chartName, data) {
    ...
    switch (chartName) {
      case 'ticket-price': // price graph
        d = ticketsFunc(data)
        assign(gOptions, mapDygraphOptions(d, ['Date', 'Ticket Price'], true, 'Price (PFC)', 'Date', undefined, false, false))
        break
      ...
      case 'coin-supply': // supply graph
        d = supplyFunc(data)
        assign(gOptions, mapDygraphOptions(d, ['Date', 'Coin Supply'], true, 'Coin Supply (PFC)', 'Date', undefined, true, false))
        break

      case 'fee-per-block': // block fee graph
        d = blockFeeFunc(data)
        assign(gOptions, mapDygraphOptions(d, ['Block Height', 'Total Fee'], false, 'Total Fee (PFC)', 'Block Height',
          undefined, true, false))
        break
