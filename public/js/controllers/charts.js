    ...
    function plotGraph (value, data, g){
        ...
        switch(value){
            case 'ticket-price': // price graph
                d = ticketsFunc(data)
                gOptions = mapDygraphOptions(d, ['Date', 'Price'], true, 'Price (PicFight)', 'Date', 'Ticket Price', false, false)
            break;
            ...
            case 'fee-per-block': // block fee graph
                d = blockFeeFunc(data)
                gOptions = mapDygraphOptions(d, ['Block Height', 'Total Fee'], false, 'Total Fee (PFC)', 'Block Height', 
