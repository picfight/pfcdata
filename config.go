...
const (
	defaultConfigFilename = "pfcdata.conf"
	defaultLogFilename    = "pfcdata.log"
...
var (
	...
	defaultMainnetLink = "https://explorer.pfcdata.org/"
	defaultTestnetLink = "https://testnet.pfcdata.org/"
...
type config struct {
	...
	BlockPrefetch    bool   `long:"pfcd-block-prefetch" short:"P" description:"Pre-fetch blocks from pfcd during startup sync."`
	...
	// Links
	MainnetLink string `long:"mainnet-link" description:"When pfcdata is on testnet, this address will be used to direct a user to a pfcdata on mainnet when appropriate." env:"PFCDATA_MAINNET_LINK"`
	TestnetLink string `long:"testnet-link" description:"When pfcdata is on mainnet, this address will be used to direct a user to a pfcdata on testnet when appropriate." env:"PFCDATA_TESTNET_LINK"`
}
