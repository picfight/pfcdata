...
type DB struct {
	*sql.DB
	...
	// Drop shutdownPfcdata when the "database is locked" error is mitigated.
	// See https://github.com/picfight/pfcdata/issues/1133 for more info.
	shutdownPfcdata func()
...
// until resolved. See https://github.com/picfight/pfcdata/issues/1133 for info.
...
func (db *DB) JustifyTableStructures(dbInfo *DBInfo) error {
	...
	bkpPath := filepath.Join(directory, "pfcdata.nosidechains-bkp.db")
