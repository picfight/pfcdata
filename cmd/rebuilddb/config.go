...
func cleanAndExpandPath(path string) string {
	...
	if strings.HasPrefix(path, "~") {
		homeDir := filepath.Dir(pfcdHomeDir)
...
//     DaemonHostPort string `json:"pfcdhost"`
//     DaemonUser string `json:"pfcduser"`
//     DaemonPass string `json:"pfcdpass"`
