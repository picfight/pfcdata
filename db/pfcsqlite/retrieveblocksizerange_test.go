...
func TestRetrieveBlockSizeRange(t *testing.T) {
	testutil.BindCurrentTestSetup(t)
	db := InitTestDB(DBPathForTest())
	testEmptyDBRetrieveBlockSizeRange(db)
}

func testEmptyDBRetrieveBlockSizeRange(db *DB) {
	//testing zero offset
	{
