...
testrepo () {
  ...
  git clone https://github.com/pfclabs/bug-free-happiness $TMPDIR
  ...
  # Set up the tests db.
  psql -U postgres -c "DROP DATABASE IF EXISTS pfcdata_mainnet_test"
  psql -U postgres -c "CREATE DATABASE pfcdata_mainnet_test"
