...
var darkBGCookieName = 'pfcdataDarkBG'
...
function toggleToDarkClasses (body) {
  sunIcon.classList.remove('pfcicon-sun-fill')
  sunIcon.classList.add('pfcicon-sun-stroke')
  body.classList.add('darkBG')
}
function toggleToLightClasses (body) {
  body.classList.remove('darkBG')
  sunIcon.classList.remove('pfcicon-sun-stroke')
  sunIcon.classList.add('pfcicon-sun-fill')
}
