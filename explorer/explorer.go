...
import (
	...
	"github.com/picfight/pfcdata/explorer/types"
	"github.com/picfight/pfcdata/gov/agendas"
	pitypes "github.com/picfight/pfcdata/gov/politeia/types"
...
type links struct {
	...
	BtcAddress      string
	DownloadLink    string
	// Testnet and below are set via pfcdata config.
	Testnet       string
	Mainnet       string
...
var explorerLinks = &links{
	CoinbaseComment: "https://github.com/picfight/pfcd/blob/2a18beb4d56fe59d614a7309308d84891a0cba96/chaincfg/genesis.go#L17-L53",
	POSExplanation:  "https://docs.picfight.org/faq/proof-of-stake/general/#9-what-is-proof-of-stake-voting",
	APIDocs:         "https://github.com/picfight/pfcdata#apis",
	Github:          "https://github.com/picfight/pfcdata",
	License:         "https://github.com/picfight/pfcdata/blob/master/LICENSE",
	NetParams:       "https://github.com/picfight/pfcd/blob/master/chaincfg/params.go",
	BtcAddress:      "https://live.blockcypher.com/btc/address/",
	DownloadLink:    "https://picfight.org/downloads/",
}
...
func (exp *explorerUI) Store(blockData *blockdata.BlockData, msgBlock *wire.MsgBlock) error {
	...
	if !exp.AreDBsSyncing() && !exp.liteMode {
		...
		// https://docs.picfight.org/advanced/navigating-politeia-data/#voting-and-comment-data
